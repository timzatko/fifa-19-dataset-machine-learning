...
\begin{figure}%
    \centering
    \subfloat[Úspešnosť pri klasifikácií `Position 4` podľa počtu použitých atribútov]{{ 
        \includegraphics[width=5.5cm]{images/feature_selection_classification_position_4}
    }}%
    \qquad
    \subfloat[Úspešnosť pri klasifikácií `Position 13` podľa počtu použitých atribútov]{{
