...
Pri riešení klasifikačnej úlohy rozšírime základnú sadu atribútov o atribúty \textit{Preferred Foot}, \textit{Work Rate Attack} a \textit{Work Rate Defense}. Pri regresnej úlohe využijeme dopočítaný atribút \textit{Contract Length}.
...
\paragraph{Klasifikácia} -- keďže klasifikujeme do 4 resp. 13 tried, ktoré sú nevyvážené, budeme sledovať metriku \textbf{f1 micro}. Táto metrika je harmonickým priemerom \textit{precision} a \textit{recall}. \textbf{micro} varianta sa používa keď sú predikované triedy nevyvážené \cite{opitz2019macro}.
...
\begin{table}[]
    ...
    \hline
    \multicolumn{1}{|c|}{\multirow{2}{*}{Model}} & \multicolumn{5}{c|}{Position (4) -- f1 skóre}  & \multicolumn{1}{l|}{Position (13) -- f1 skóre} \\
    \multicolumn{1}{|c|}{}                       & Attack & Defense & Goalkeeper & Middle & Micro & Micro                                          \\ \cline{2-7} 
    Rozhodovací strom                            & 0.74   & 0.87    & 1          & 0.76   & 0.81  & 0.55                                           \\
    Logistická regresia                          & 0.82   & 0.94    & 1          & 0.87   & 0.87  & 0.71                                           \\
    SVM                                          & 0.81   & 0.93    & 1          & 0.84   & 0.88  & 0.66                                           \\
    Náhodný les                                  & 0.81   & 0.93    & 1          & 0.86   & 0.89  & 0.68                                           \\ \hline
    \end{tabular}
    \\
...
\begin{figure}%
    ...
    \caption{Matice zmätenia pre dva z našich antrénovaných modelov, môžeme si všimnúť že model robí chyby pri klasifikácii do triedy \textit{middle}.}%
    \label{fig:confusion_matrix_position_4}%
\end{figure}

\subsection{Predikcia trhovej hodnoty hráča (regresia)}

Na riešenie tejto úlohy sme využili lineárnu regresiu. V tejto úlohe sa nám zatiaľ nepodarilo dosiahnuť výraznejšie výsledky \ref{fig:wage_value_scatter_plot}.

\begin{figure}[htp]
    \centering
    \includegraphics[height=5cm]{images/wage_value_scatter_plot}
    ...
    \label{fig:wage_value_scatter_plot}
\end{figure}
